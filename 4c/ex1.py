...
for i in range(WORLD_SPACE):
    ...
    for j in range(WORLD_SPACE):
        ...
        if [i, j] == TERMINAL_STATE1:
            next_reward["R"] = next_reward["L"] = next_reward["D"] = next_reward["U"] = 0
            next_position["R"] = next_position["L"] = next_position["D"] = next_position["U"] = TERMINAL_STATE1

        if [i,j] == TERMINAL_STATE2:
            next_reward["R"] = next_reward["L"] = next_reward["D"] = next_reward["U"] = 0
            next_position["R"] = next_position["L"] = next_position["D"] = next_position["U"] = TERMINAL_STATE2
